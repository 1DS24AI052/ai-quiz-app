const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginPage-D-SxVQFj.js","assets/Layout-BD15tm6S.js","assets/sparkles-CixeY9rq.js","assets/TeacherDashboard-CQUg3Otp.js","assets/quizStore-D_LTbw6t.js","assets/plus-BGeam5Tr.js","assets/clock-ButitRSs.js","assets/chevron-right-DRU3fgvc.js","assets/StudentDashboard-D3aZE8fz.js","assets/CreateQuizPage-Blqq-nzu.js","assets/circle-check-big-ZoL-LoZ6.js","assets/arrow-left-BzHFHNRS.js","assets/GenerateQuizPage-BiXp2wy2.js","assets/QuizAttemptPage-DsvE8FOF.js","assets/ResultPage-Dt_7Tkxz.js"])))=>i.map(i=>d[i]);
...
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-D-SxVQFj.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const TeacherDashboard = reactExports.lazy(() => __vitePreload(() => import("./TeacherDashboard-CQUg3Otp.js"), true ? __vite__mapDeps([3,1,4,5,2,6,7]) : void 0));
const StudentDashboard = reactExports.lazy(() => __vitePreload(() => import("./StudentDashboard-D3aZE8fz.js"), true ? __vite__mapDeps([8,1,4,2,6]) : void 0));
const CreateQuizPage = reactExports.lazy(() => __vitePreload(() => import("./CreateQuizPage-Blqq-nzu.js"), true ? __vite__mapDeps([9,1,4,5,10,11]) : void 0));
const GenerateQuizPage = reactExports.lazy(() => __vitePreload(() => import("./GenerateQuizPage-BiXp2wy2.js"), true ? __vite__mapDeps([12,1,4,2,10,11]) : void 0));
const QuizAttemptPage = reactExports.lazy(() => __vitePreload(() => import("./QuizAttemptPage-DsvE8FOF.js"), true ? __vite__mapDeps([13,1,4,7,11]) : void 0));
const ResultPage = reactExports.lazy(() => __vitePreload(() => import("./ResultPage-Dt_7Tkxz.js"), true ? __vite__mapDeps([14,1,4,10]) : void 0));
...
function LoadingFallback() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full border-2 border-primary border-t-transparent animate-spin" }) });
}
function App() {
  const { isLoggedIn, role } = useAuthStore();
  const [current, setCurrent] = reactExports.useState({
    page: isLoggedIn ? role === "teacher" ? "teacher-dashboard" : "student-dashboard" : "login"
  });
  const navigate = (state) => setCurrent(state);
  const renderPage = () => {
    if (!isLoggedIn) return /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {});
    switch (current.page) {
      case "teacher-dashboard":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TeacherDashboard, {});
      case "student-dashboard":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(StudentDashboard, {});
      case "create-quiz":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CreateQuizPage, {});
      case "generate-quiz":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(GenerateQuizPage, {});
      case "quiz-attempt":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(QuizAttemptPage, { quizId: current.quizId });
      case "result":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ResultPage, { quizId: current.quizId });
      default:
        return role === "teacher" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TeacherDashboard, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(StudentDashboard, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationContext.Provider, { value: { navigate, current }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}), children: renderPage() }) });
}
